                    ...
                    data.map((gol) => {
                        return (
                            <>
                                ...
                                <div className='flex space-x-16 p-4' >
                                    <div className='flex space-x-4 justify-center items-center'>
                                        ...
                                        <div>
                                            ...
                                            <h1 className={`${fredoka.className} text-2xl text-gray-800`}>{gol.amountSaved}</h1>
                                        </div>
                                    </div>
                                    <div className='flex space-x-4 justify-center items-center'>
                                        ...
                                        <div>
                                            ...
                                            <h1 className={`${fredoka.className} text-2xl text-gray-800`}>{gol.amount}</h1>
                                        </div>
                                    </div>
                                ...
                                <div className='flex space-x-3 p-4 py-6 '>
                                    <div>
