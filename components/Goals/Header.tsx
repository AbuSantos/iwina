...
const Header = () => {
    ...
    return (
        <div>
            ...
            <div className="p-4">
                <p className={`${fredoka.className} text-xl text-center p-3 text-slate-700`}>Select the goal that you want to achieve</p>
            </div>

            <div className="flex m-auto items-center bg-transparent rounded-lg w-10/12  border-2 border-slate-300 ">
