...
const BankModal = ({ setOpenBankModal, bankname, setBankName, handleSubmit, setBankDetails, bankDetails }) => {
                    ...
                    <section className=' w-full p-2'>
                        ...
                        <div className='mt-2'>
                            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                                className="text-white bg-violet-700 font-medium rounded-t-md px-5 text-sm w-[9rem] py-2.5 w text-center inline-flex items-center outline-none" type="button"
                            ...
                            </button>
                            {
                                ...
                                <div id="dropdown" className="z-10   divide-y divide-gray-100 rounded-lg  w-36 ">
                                    <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                        <li>
                                            <a href="#" className="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white mb-2 dark:bg-gray-700 " onClick={() => handleNameChange("OPAY")}>Opay</a>
                                        </li>
                                        <li>
